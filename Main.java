...
//                            value1 = valueString1.get(j);
                        } else {
                            value1.append(valueString1.get(j));
//                            value1 += valueString1.get(j);
                        }
                    }
                }else if((val == '"') && (value2 == null) && (operation != ' ')){
//                    Код для второго значения
                ...
                }else if ((value1 != null) && (value2 == null) && (operation != ' ') && (valOptional == '1' || valOptional == '2' || valOptional == '3' || valOptional == '4' || valOptional == '5' || valOptional == '6' || valOptional == '7' || valOptional == '8' || valOptional == '9' || valOptional == '0')){
                    if(valueInt.equals(" ")){
        ...
        if((valueDefault == 0 && valueInt.equals("0")) || (valueDefault > 10)){
            ...
            System.out.println("Была введена некоректная цифра");
            return;
        }
        if((value1.toString().length() > 10) || (value2.toString().length() > 10)){
            //Тут будет условия про диапазон цифр второго значения от 1 до 10
            System.out.println("Было введено слишком большое слово");
            return;
        }
        ...
        switch(operation) {
            ...
            case '/':
                if(valueDefault != 0){
                    ...
                    System.out.println("Вторым значением должна быть цифра");
                }
                break;
            case '-':
                if(valueInt.equals(" ")){
